...
var OELib =
{
     ...
     *
     * Example: OELib.logMessage("Swiping to the Left", kLogType.Start);
     *
     */
    ...
    /** alertHandler(buttonName);
     *
     * Description: Checks for an iOS alert and selects the default or cancel button.
     *
     * 1 Parameter:
     *      @param {string} Name of Button
     *
     * Example: OELib.alertHandler("Default");
     *
     */
    ...
    /** advancedOrderPlacement(email, account);
     *
     * Description: ???
     *
     * 2 Parameter:
     ...
     *
     * Example: OELib.attachToLocation("501")
     *
     */
    attachToLocation: function(locationNumber)
    {
        this.alertHandler("Default");
     ...
     *
     * Example: OELib.loginWithUserNumber("1111")
     *
     */
     ...
     * No Parameters
     *
     * Example: OELib.clearScreenSaver();
     *
     */
    ...
    /** tapElementWithOptions(name, timeout, offSet)
     *
     * Description:
     *
     * 3 Parameters
    ...
    /** tapElementNamed(name, timeout)
     *
     * Description: This function taps an element that is present in the current window.
     *
     * 2 Parameters:
     *      @param {string} name of the element
     *      @param {integer} number of seconds before timeout
     *
     * Example: OELib.tapElementNamed("Coke")
     *
     */
     ...
     *
     * Example: OELib.waitForElementNamed("Coke", 10)
     *
     */
     ...
     *
     * Description: Call this function at the beginning of your script to execute a few obj-c methods that return the device to a default state.
     *
     * No Parameters
     *
     * Example: OELib.resetDeviceToDefault()
     *
     */
    resetDeviceToDefault: function()
    {
        OELib.waitForElementNamed("LoginKeypad - 1");
        OELib.tapElementNamed("Reset");
